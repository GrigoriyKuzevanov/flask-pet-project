"""add fields to consumption model

Revision ID: 3443faab1f0a
Revises: b4a47f7f526d
Create Date: 2024-02-09 15:16:21.094072
...
revision = '3443faab1f0a'
down_revision = 'b4a47f7f526d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('consumption', schema=None) as batch_op:
        ...
        batch_op.alter_column('renovation',
               ...
               type_=sa.Float(precision=12),
               existing_nullable=True)
        batch_op.create_index(batch_op.f('ix_consumption_month'), ['month'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('consumption', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_consumption_month'))
        batch_op.alter_column('renovation',
               existing_type=sa.Float(precision=12),
               type_=sa.REAL(),
               existing_nullable=True)
