...
Revision ID: 1d8809778444
Revises: 02808886c551
Create Date: 2024-02-07 15:03:14.069246
...
revision = '1d8809778444'
down_revision = '02808886c551'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('invoice_model', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_invoice_model_created_at'), ['created_at'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('invoice_model', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_invoice_model_created_at'))
